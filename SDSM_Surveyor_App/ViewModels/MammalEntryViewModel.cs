...
public partial class MammalEntryViewModel : ObservableObject, ISingletonService
{
    internal const string TaxonKey = "Mammal";
    private readonly ISpeciesListProvider _speciesProvider;
    private readonly ISessionService _sessions;

    public MammalEntryViewModel(ISpeciesListProvider speciesProvider, ISessionService sessions,
                                SurveyMeta meta)
    {
